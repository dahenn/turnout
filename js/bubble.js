var chart2margin = {top: 20, right: 50, bottom: 30, left: 50},
    chart2width = parseInt(d3.select('#chart2').style('width')) - margin.left - margin.right,
    chart2height = 600 - margin.top - margin.bottom;

var chart2svg = d3.select("div#chart2").append("svg")
    .attr("width", chart2width + margin.left + margin.right)
    .attr("height", chart2height + margin.top + margin.bottom);
